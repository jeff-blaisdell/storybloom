# Django settings for storybloom project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(SETTINGS_DIR, 'storybloom.sqlite'),                      # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'storybloom.herokuapp.com', 'www.storybloom.org']
...
ROOT_URLCONF = 'storybloom.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'storybloom.wsgi.application'
